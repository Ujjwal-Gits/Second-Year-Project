...
const ImagePreviewModal = ({
  ...
  const isCitizenshipPreview =
    previewImage ===
    (selectedAgent?.citizenshipImage?.startsWith("http")
      ? selectedAgent.citizenshipImage
      : `${import.meta.env.VITE_API_URL}${selectedAgent?.citizenshipImage}`);
  ...
  return (
    ...
    >
      ...
      >
        <span className="material-icons text-xl group-hover:rotate-90 transition-transform">
          close
        </span>
      </button>
        ...
        {isCitizenshipPreview ? (
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 w-full h-[72vh] items-center justify-center">
            <motion.div
              ...
              className="flex flex-col items-center justify-center flex-1 w-full max-h-[45%] lg:max-h-full"
            >
            ...
            >
              ...
              <img
                src={
                  selectedAgent?.citizenshipBackImage
                    ? selectedAgent.citizenshipBackImage.startsWith("http")
                      ? selectedAgent.citizenshipBackImage
                      : `${import.meta.env.VITE_API_URL}${selectedAgent.citizenshipBackImage}`
                    : previewImage
                }
                style={{
                  transform: `scale(${zoomLevel})`,
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center w-full h-[82vh]"
          >
            <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.3em] mb-4 whitespace-nowrap">
              High-Resolution PAN Document
            </p>
            <img
              src={previewImage}
              style={{
          ...
          <div className="flex items-center gap-3 w-full md:w-auto overflow-x-auto no-scrollbar">
            ...
            {isCitizenshipPreview ? (
              <div className="flex items-center gap-4 whitespace-nowrap">
                <p className="text-white/80 text-[10px] lg:text-[11px] font-black uppercase tracking-[0.1em]">
                  <span className="text-white/40 mr-1.5">OWNER:</span>
                  {selectedAgent?.companyOwner || selectedAgent?.fullName}
                </p>
                <div className="w-1 h-1 rounded-full bg-white/20" />
                <p className="text-white/80 text-[10px] lg:text-[11px] font-black uppercase tracking-[0.1em]">
                  <span className="text-white/40 mr-1.5">CITIZENSHIP NO:</span>
                  {selectedAgent?.citizenshipNumber || "N/A"}
                </p>
                <div className="w-1 h-1 rounded-full bg-white/20" />
                <p className="text-white/80 text-[10px] lg:text-[11px] font-black uppercase tracking-[0.1em]">
                  <span className="text-white/40 mr-1.5">DISTRICT:</span>
                  {selectedAgent?.citizenshipDistrict || "N/A"}
                </p>
                <div className="w-1 h-1 rounded-full bg-white/20" />
                <p className="text-white/80 text-[10px] lg:text-[11px] font-black uppercase tracking-[0.1em]">
                  <span className="text-white/40 mr-1.5">ISSUE DATE:</span>
                  {selectedAgent?.citizenshipIssueDate || "N/A"}
                </p>
              </div>
            ) : (
              <div className="flex items-center gap-4 whitespace-nowrap">
                <p className="text-white/80 text-[10px] lg:text-[11px] font-black uppercase tracking-[0.1em]">
                  <span className="text-white/40 mr-1.5">COMPANY:</span>
                  {selectedAgent?.companyName || selectedAgent?.fullName}
                </p>
                <div className="w-1 h-1 rounded-full bg-white/20" />
                <p className="text-white/80 text-[10px] lg:text-[11px] font-black uppercase tracking-[0.1em]">
                  <span className="text-white/40 mr-1.5">PAN NUMBER:</span>
                  {selectedAgent?.panNumber || "N/A"}
                </p>
              </div>
            )}
          </div>
          <div className="hidden md:block h-4 w-px bg-white/10 shrink-0" />
          <p className="hidden md:block text-white/40 text-[9px] font-bold uppercase tracking-widest whitespace-nowrap">
...
const SuperDashboard = ({ user, onLogout }) => {
  ...
  const [adRequests, setAdRequests] = useState([
    {
      id: "ADV-001",
      agent: "Himalayan Treks Pvt. Ltd.",
      listing: "Everest Base Camp Trek - 14 Days",
      type: "Featured Destination (Homepage)",
      typeKey: "featured",
      duration: "1 Month",
      durationDays: 30,
      ...
      price: 22000,
      designService: true,
      link: "https://hamroyatra.com/listing/everest-bc",
    ...
    {
      id: "ADV-002",
      agent: "Pokhara Luxury Stays",
      listing: "Pokhara Lakeside Premium Suite",
      type: "Festival Highlight",
      typeKey: "festival",
      duration: "2 Weeks",
      durationDays: 14,
      ...
      price: 9000,
      designService: false,
      link: "https://hamroyatra.com/listing/pokhara-suite",
      submitted: "2026-03-19",
      status: "pending",
    ...
    {
      id: "ADV-003",
      agent: "Chitwan Safari Experts",
      listing: "Chitwan Jungle Safari Master Pack",
      type: "Exclusive Deals Section",
      typeKey: "discounts",
      duration: "1 Week",
      durationDays: 7,
      ...
      price: 2500,
      designService: false,
      link: "https://hamroyatra.com/listing/chitwan-safari",
  ...
  const [toggles, setToggles] = useState([
    {
      id: "maintenance",
      title: "Network Maintenance Mode",
      desc: "Restrict public access for system upgrades. Active sessions preserved.",
      active: false,
      icon: "build",
    },
    {
      id: "partner_intake",
      title: "New Partner Intake Protocol",
      desc: "Authorize new agency registrations. Disabling locks all become-partner vectors.",
      active: true,
      icon: "handshake",
    },
    {
      id: "api_sync",
      title: "Real-time API Synchronization",
      desc: "Secondary sync across distributed edge nodes for zero-latency traveler updates.",
      active: true,
      icon: "sync",
    },
    {
      ...
      desc: "Neural compliance monitoring for all verification requests.",
      active: true,
      icon: "security",
    },
    {
      id: "ad_module",
      title: "Advertising Module Live",
      desc: "Enable or disable the advertising portal for all agent accounts globally.",
      active: true,
      icon: "campaign",
    },
  ]);
  ...
  const fetchDashboardData = async () => {
    try {
      const [agentsRes, travellersRes, statsRes] = await Promise.all([
        axios.get(
          `${import.meta.env.VITE_API_URL}/api/dashboard/super/agents`,
          {
            headers: { "auth-token": localStorage.getItem("token") },
          },
        ),
        axios.get(
          `${import.meta.env.VITE_API_URL}/api/dashboard/super/travellers`,
          {
            headers: { "auth-token": localStorage.getItem("token") },
          },
        ),
        axios.get(
          `${import.meta.env.VITE_API_URL}/api/dashboard/super/stats?range=${timeRange}`,
          {
            headers: { "auth-token": localStorage.getItem("token") },
          },
        ),
  ...
  const handleVerifyAgent = async (id, status, verified) => {
    try {
      await axios.put(
        `${import.meta.env.VITE_API_URL}/api/dashboard/super/verify-agent/${id}`,
        { status, verified },
  ...
  const handleReviewAd = (id, status) => {
    ...
    if (status === "approved") {
      if (ad.status === "approved") {
        ...
        setAdRequests((prev) =>
          prev.map((r) =>
            r.id === id ? { ...r, status: "pending", approvedAt: null } : r,
          ),
        );
        if (selectedAdReview?.id === id) {
          setSelectedAdReview((prev) => ({
  ...
  const stats = [
    ...
    },
    {
      ...
      value: platformStats.verifiedAgents || 0,
      icon: "verified",
      color: "text-[#C5A059]",
      bg: "bg-[#C5A059]/10",
    },
    {
      ...
      value: platformStats.totalTravellers || 0,
      icon: "group",
  ...
  return (
    <div className="h-screen bg-[#FBFBFB] flex font-display overflow-hidden">
      ...
      <aside
        className={`fixed lg:static inset-y-0 left-0 w-72 lg:w-60 bg-[#0D1F18] flex flex-col h-full shrink-0 z-[100] transition-transform duration-500 ease-out border-r border-white/5 lg:translate-x-0 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        {/* Subtle aurora */}
        ...
        <div className="h-[72px] flex items-center px-6 border-b border-white/5 shrink-0 relative z-10">
          <img
            src={HamroLogo}
            alt="Hamroyatra"
            className="w-7 h-7 object-contain brightness-0 invert opacity-90 mr-3"
          />
          <div>
            <p className="text-white text-[11px] font-black tracking-[0.25em] uppercase leading-none">
              Super Terminal
            </p>
            <p className="text-[#C5A059] text-[8px] tracking-[0.3em] uppercase opacity-60 mt-0.5">
              Nepal Master Console
            </p>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  <span
                    className={`material-icons text-[18px] relative z-10 ${isActive ? "text-white" : ""}`}
                  >
                    {item.icon}
                  </span>
                </div>
                <span className="text-[12px] font-semibold tracking-wide relative z-10">
                  {item.label}
                </span>
              </button>
            );
          ...
          <div className="pt-8 mb-4">
            ...
            >
              {activeTab === "controls" && (
                <motion.div
                  layoutId="activePillSuper"
                  className="absolute inset-0 bg-[#1D7447] rounded-lg"
                  transition={{ type: "spring", stiffness: 400, damping: 35 }}
                />
              )}
              <span className="material-icons text-[18px] relative z-10">
                settings
              </span>
              <span className="text-[12px] font-semibold tracking-wide relative z-10">
                Global Controls
        ...
        <div className="px-6 pb-4 relative z-10 border-t border-white/5 mx-2">
          <div className="pt-4 pb-2">
            ...
            >
              <div className="w-7 h-7 rounded-lg bg-white/5 flex items-center justify-center group-hover:bg-primary transition-colors">
                <span className="material-icons text-white/40 group-hover:text-white text-[14px]">
                  public
                </span>
              </div>
              <span className="text-white/40 text-[9px] font-black uppercase tracking-[0.2em] group-hover:text-white transition-colors">
                View Website
              </span>
              <span className="material-icons text-white/10 text-[12px] ml-auto group-hover:translate-x-1 transition-transform">
                arrow_forward
              </span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-3 px-4 py-3 bg-white/5 rounded-lg border border-white/5 mt-2">
            <div className="w-8 h-8 rounded bg-primary/20 flex items-center justify-center text-primary font-black text-xs">
              SA
            </div>
            <div className="min-w-0">
              <p className="text-white text-[11px] font-black tracking-wide truncate">
                Super Admin
              </p>
              <p className="text-[#C5A059] text-[8px] tracking-[0.2em] uppercase opacity-60 leading-tight">
                Master Node
              </p>
            </div>
          </div>
          ...
          <header className="mb-10 md:mb-12">
            ...
            <div className="lg:hidden flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-3">
                ...
                <div
                  className="w-10 h-10 rounded-full bg-[#0D1F18] flex items-center justify-center text-white text-[11px] font-extrabold shadow-lg shadow-[#0D1F18]/10"
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 md:gap-6">
              <div>
                <div className="flex items-center gap-3 mb-1 lg:mb-2">
                  ...
                  <span className="text-[10px] font-black text-[#C5A059] uppercase tracking-[0.3em] hidden md:block">
                    Master Active
                  </span>
                </div>
                <p className="text-[9px] lg:text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] leading-relaxed">
              ...
              <div className="hidden lg:flex items-center gap-6">
                <div className="relative group">
                  <span className="material-icons absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 text-base group-focus-within:text-primary transition-colors">
                    search
                  </span>
                  <input
                    value={searchQuery}
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    >
                      ...
                      <div className="hidden lg:block text-left">
                        <p className="text-[13px] font-black text-[#0D1F18] leading-none group-hover:text-primary transition-colors">
                          {user?.fullName || "Super Admin"}
                        </p>
                        <p className="text-[9px] text-[#C5A059] mt-1.5 uppercase font-bold tracking-widest opacity-80">
                          Master Authority
                        </p>
                      </div>
                      <span
                        className="material-icons text-gray-300 text-[18px] transition-transform group-hover:text-gray-400"
                        style={{
                        ...
                        >
                          <div className="px-5 py-4 border-b border-gray-50/60 mb-2">
                            <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest truncate">
                              {user?.email || "admin@hamroyatra.com"}
                            </p>
                          </div>
                          <button
                          ...
                          >
                            <span className="material-icons text-[18px] text-gray-400 group-hover/opt:text-[#0D1F18] transition-colors">
                              settings
                            </span>
                    ...
                    {stats.map((stat, idx) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-6">
                          <div
                            className={`w-11 h-11 rounded-2xl flex items-center justify-center ${stat.bg} ${stat.color} border border-white shadow-sm`}
                          >
                          ...
                          <div className="px-2 py-1 bg-emerald-50 rounded-lg">
                            <span className="text-[9px] font-bold text-emerald-600 tracking-wide">
                              +2.4%
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                    ...
                    <div className="lg:col-span-2 bg-white p-5 lg:p-8 rounded-3xl lg:rounded-[32px] border border-gray-100 shadow-sm relative overflow-hidden group">
                      <div className="flex items-center justify-between mb-8 relative z-10">
                        <div>
                          <h4 className="text-[13px] font-black text-[#0D1F18] uppercase tracking-[0.2em]">
                            Operational Earnings
                          </h4>
                          <p className="text-[10px] font-bold text-gray-400 mt-1 uppercase tracking-[0.15em]">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div
                            className="w-9 h-9 bg-primary/8 rounded-xl flex items-center justify-center text-primary"
                            style={{ background: "rgba(29,116,71,0.08)" }}
                          >
                            ...
                            datasets: [
                              {
                                ...
                                data:
                                  revenueHistory.length > 0
                                    ? revenueHistory.map((h) => h.total)
                                    : [300, 450, 420, 580, 520, 700],
                                borderColor: "#1D7447",
                                backgroundColor: (ctx) => {
                          ...
                          options={{
                            ...
                            plugins: {
                              ...
                              tooltip: {
                                ...
                                callbacks: {
                                  label: (ctx) =>
                                    ` NPR ${ctx.parsed.y.toLocaleString()}`,
                                },
                              },
                            },
                            scales: {
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden group">
                      <div className="mb-6 relative z-10">
                        <div>
                          <h4 className="text-[11px] font-black text-[#0D1F18] uppercase tracking-[0.2em] mb-1">
                            Global Allocation
                          </h4>
                      ...
                      <div className="flex flex-col items-center">
                          ...
                          <Doughnut
                            data={{
                              ...
                              datasets: [
                                {
                                  data:
                                    platformStats.userDistribution.length > 0
                                      ? platformStats.userDistribution.map(
                                          (d) => d.value,
                                        )
                                      : [12, 28, 60],
                                  backgroundColor: [
                        ...
                        <div className="w-full mt-5 space-y-2.5">
                          {[
                            ...
                            const value =
                              platformStats.userDistribution[i]?.value || 0;
                            return (
                              <div
                                key={item.label}
              ...
              {activeTab === "verification" && (
                <div className="space-y-8">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-[13px] font-black text-[#0D1F18] uppercase tracking-[0.2em]">
                        Compliance Pipeline
                      </h3>
                      <p className="text-[10px] font-bold text-gray-400 mt-1 uppercase tracking-widest">
                        {pendingAgents.length} Active Partner Reviews
                      </p>
                    </div>
                  </div>
                  ...
                  {pendingAgents.length === 0 ? (
                    <div className="bg-white rounded-[40px] border border-gray-100 p-24 flex flex-col items-center text-center shadow-sm">
                      ...
                      <h4 className="text-[14px] font-black text-[#0D1F18] uppercase tracking-widest">
                        Queue Synchronized
                      </h4>
                      <p className="text-gray-400 text-[10px] mt-3 max-w-xs mx-auto font-bold uppercase tracking-widest leading-relaxed">
                        System integrity is optimal. No pending verifications
                        found.
                      </p>
                    </div>
                  ) : (
                    <div className="bg-white rounded-3xl lg:rounded-[40px] border border-gray-100 shadow-sm overflow-hidden">
                      <div className="p-2 lg:p-4 no-scrollbar bg-[#FBFBFB]/50">
                        ...
                        <div className="hidden lg:flex items-center px-10 py-2 mb-1 border-b border-gray-100">
                          <div className="w-[8%] text-[8px] font-black text-gray-300 uppercase tracking-widest">
                            UID
                          </div>
                          <div className="w-[30%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-left">
                            Partner Entity
                          </div>
                          <div className="w-[18%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-center">
                            Legal Vector (PAN)
                          </div>
                          <div className="w-[18%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-center">
                            Node Location
                          </div>
                          <div className="w-[16%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-center">
                            Compliance Status
                          </div>
                          <div className="w-[10%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-right">
                            Audit
                          </div>
                        </div>
                            ...
                            >
                              ...
                              <div className="lg:w-[30%] flex items-center gap-3 mb-5 lg:mb-0">
                                ...
                                <div className="truncate">
                                  <p className="text-[13px] lg:text-[11px] font-black text-[#0D1F18] tracking-tight truncate leading-tight">
                                    {agent.companyName}
                                  </p>
                                  <p className="text-[9px] lg:text-[8px] text-gray-400 font-bold tracking-tight uppercase opacity-60">
                                    Owner: {agent.fullName || "Unspecified"}
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="grid grid-cols-2 gap-4 mb-5 lg:mb-0 lg:contents">
                                <div className="lg:w-[18%] lg:text-center">
                                  ...
                                  <p className="text-[11px] lg:text-[10px] font-extrabold text-[#0D1F18] tracking-widest">
                                    {agent.panNumber}
                                  </p>
                                </div>
                                <div className="lg:w-[18%] lg:text-center">
                                  ...
                                  <p className="text-[11px] lg:text-[10px] font-bold text-gray-400 uppercase truncate">
                              ...
                              <div className="lg:w-[10%] pt-4 lg:pt-0 border-t lg:border-none border-gray-50 flex items-center justify-between lg:justify-end">
                                <div className="lg:hidden text-[9px] font-black text-gray-300 uppercase tracking-widest">
                                  Master Audit
                                </div>
                                <button
                                  onClick={() => setSelectedAgent(agent)}
                                  className="w-8 h-8 rounded-lg bg-gray-50 text-gray-300 hover:text-amber-600 transition-all flex items-center justify-center lg:ml-auto border border-gray-100"
                                >
                                  <span className="material-icons text-[16px] lg:text-[14px]">
                                    remove_red_eye
                                  </span>
                                </button>
                              </div>
                ...
                <div className="bg-white rounded-3xl lg:rounded-[40px] border border-gray-100 shadow-sm overflow-hidden">
                  <div className="px-5 lg:px-8 py-4 border-b border-gray-50 flex items-center justify-between bg-white relative">
                    <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-8">
                      <div>
                        <h3 className="text-[12px] lg:text-[14px] font-black text-[#0D1F18] tracking-tight uppercase tracking-widest">
                          Partner Directory
                        </h3>
                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-[0.2em] leading-none mt-1">
                          {filteredAgents.length} Nodes Indexed
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <button className="px-3 py-1.5 lg:py-1 bg-[#0D1F18] text-white rounded-md text-[8px] font-black uppercase tracking-widest shadow-sm">
                          All Nodes
                        </button>
                        <button className="px-3 py-1.5 lg:py-1 bg-white text-gray-400 border border-gray-100 rounded-md text-[8px] font-black uppercase tracking-widest hover:border-primary/20 hover:text-primary transition-all">
                          Verified
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="p-2 lg:p-4 no-scrollbar bg-gray-50/20">
                    ...
                    <div className="hidden lg:flex items-center px-10 py-2 mb-1 border-b border-gray-100">
                      ...
                      <div className="w-[25%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-left">
                        Partner Identity
                      </div>
                      <div className="w-[20%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-center">
                        Mobile Vector
                      </div>
                      <div className="w-[22%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-center">
                        Communication
                      </div>
                      <div className="w-[15%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-center">
                        Compliance
                      </div>
                      <div className="w-[10%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-right">
                        Audit
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between mb-4 lg:mb-0 lg:w-[8%]">
                            ...
                            <div className="lg:hidden flex items-center gap-1.5 px-2 py-0.5 bg-gray-50 rounded-md border border-gray-100">
                              <div
                                className={`w-1 h-1 rounded-full ${agent.verified ? "bg-emerald-500" : "bg-amber-500"}`}
                              />
                              <span
                                className={`text-[8px] font-black uppercase tracking-widest ${agent.verified ? "text-emerald-600" : "text-amber-600"}`}
                              >
                          ...
                          <div className="lg:w-[25%] flex items-center gap-3 mb-5 lg:mb-0">
                            ...
                            <div className="truncate">
                              ...
                              <p className="text-[9px] lg:text-[8px] text-gray-400 font-bold tracking-tight truncate uppercase opacity-60">
                                Owner: {agent.fullName || "Unspecified"}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-5 lg:mb-0 lg:contents">
                            <div className="lg:w-[20%] lg:text-center">
                              ...
                              <p className="text-[11px] lg:text-[10px] font-black text-[#0D1F18]">
                                {agent.contactNumber || agent.phoneNo || "N/A"}
                              </p>
                            </div>
                            <div className="lg:w-[22%] lg:text-center overflow-hidden">
                              ...
                              <p className="text-[10px] lg:text-[9px] text-gray-400 font-bold lowercase tracking-tight truncate px-2">
                                {agent.email}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="lg:w-[10%] pt-4 lg:pt-0 border-t lg:border-none border-gray-50 flex items-center justify-between lg:justify-end">
                            <div className="lg:hidden text-[9px] font-black text-gray-300 uppercase tracking-widest">
                              Identity Node Access
                            </div>
                            <button
                              onClick={() => setSelectedAgent(agent)}
                              className="w-8 h-8 rounded-lg bg-gray-50 text-gray-300 hover:text-primary transition-all flex items-center justify-center lg:ml-auto border border-gray-100"
                            >
                              <span className="material-icons text-[16px] lg:text-[14px]">
                                visibility
                              </span>
                ...
                <div className="bg-white rounded-3xl lg:rounded-[40px] border border-gray-100 shadow-sm overflow-hidden">
                  <div className="px-5 lg:px-8 py-4 border-b border-gray-50 flex items-center justify-between bg-white relative">
                    <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-8">
                      <div>
                        ...
                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-[0.2em] leading-none mt-1">
                          {filteredTravellers.length} Accounts Operational
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <button className="px-3 py-1.5 lg:py-1 bg-[#0D1F18] text-white rounded-md text-[8px] font-black uppercase tracking-widest shadow-sm">
                        ...
                        <button className="px-3 py-1.5 lg:py-1 bg-white text-gray-400 border border-gray-100 rounded-md text-[8px] font-black uppercase tracking-widest hover:border-emerald-600/20 hover:text-emerald-600 transition-all">
                          Active Pulse
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="p-2 lg:p-4 no-scrollbar bg-gray-50/20">
                    ...
                    <div className="hidden lg:flex items-center px-10 py-2 mb-1 border-b border-gray-100">
                      ...
                      <div className="w-[22%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-left">
                        Traveler Identity
                      </div>
                      <div className="w-[18%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-center">
                        Phone Number
                      ...
                      <div className="w-[15%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-right">
                        Actions
                      </div>
                    </div>
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-5 lg:mb-0 lg:contents">
                            ...
                            <div className="lg:w-[22%] lg:text-center overflow-hidden">
                              ...
                              <p className="text-[10px] lg:text-[9px] text-gray-400 font-bold lowercase tracking-tight truncate">
                                {traveler.email}
                              </p>
                            </div>
                          </div>
              ...
              {activeTab === "analytics" &&
                (() => {
                  const filtered = adRequests.filter((r) => {
                    const matchStatus =
                      adFilter.status === "all" || r.status === adFilter.status;
                    const matchTier =
                      adFilter.tier === "all" || r.typeKey === adFilter.tier;
                    const matchSearch =
                      !adFilter.search ||
                      r.agent
                        .toLowerCase()
                        .includes(adFilter.search.toLowerCase()) ||
                      r.listing
                        .toLowerCase()
                        .includes(adFilter.search.toLowerCase());
                  ...
                  return (
                    <div className="space-y-6">
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        <div>
                          <h1 className="text-xl lg:text-2xl font-black text-[#0D1F18] tracking-tight uppercase tracking-widest">
                            Analytics
                          </h1>
                          <p className="text-[10px] font-bold text-gray-400 mt-1 uppercase tracking-widest hidden lg:block">
                            Pending sponsorship requests from verified agents
                          </p>
                        </div>
                        <div className="flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-lg px-4 py-2 w-fit">
                          ...
                          <span className="text-[10px] font-black text-amber-700 uppercase tracking-widest">
                            {
                              adRequests.filter((r) => r.status === "pending")
                                .length
                            }{" "}
                            Pending Review
                          </span>
                      ...
                      <div className="flex flex-wrap gap-3 items-center bg-white border border-gray-100 rounded-xl p-3 shadow-sm">
                        ...
                        {/* Tier Filter */}
                        <div className="relative">
                          <span className="material-icons absolute left-3 top-1/2 -translate-y-1/2 text-gray-300 text-[15px] pointer-events-none">
                            filter_list
                          </span>
                          <select
                            value={adFilter.tier}
                      ...
                      {filtered.length === 0 ? (
                        <div className="bg-white rounded-[40px] border border-gray-100 p-16 flex flex-col items-center text-center shadow-sm">
                          <span className="material-icons text-gray-200 text-5xl mb-4">
                            campaign
                          </span>
                        ...
                        <div className="bg-white rounded-3xl lg:rounded-[40px] border border-gray-100 shadow-sm overflow-hidden">
                          <div className="p-2 lg:p-4 no-scrollbar bg-[#FBFBFB]/50">
                            {/* Header Row — Hidden on Mobile */}
                            <div className="hidden lg:flex items-center px-10 py-2 mb-1 border-b border-gray-100">
                              <div className="w-[7%] text-[8px] font-black text-gray-300 uppercase tracking-widest">
                                UID
                              </div>
                              <div className="w-[30%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-left">
                                Partner & Listing
                              ...
                              <div className="w-[12%] text-[8px] font-black text-gray-300 uppercase tracking-widest text-right">
                                Audit
                              </div>
                            </div>
                                ...
                                >
                                  ...
                                  <div className="lg:w-[30%] flex items-center gap-3 mb-5 lg:mb-0">
                                    ...
                                    <div className="truncate">
                                      ...
                                      <p className="text-[9px] lg:text-[8px] text-gray-400 font-bold tracking-tight uppercase opacity-60 truncate">
                                        {req.listing}
                                      </p>
                                    </div>
                                  </div>
                                  ...
                                  <div className="grid grid-cols-2 gap-4 mb-5 lg:mb-0 lg:contents">
                                    <div className="lg:w-[18%] lg:text-center">
                                      ...
                                      <div className="inline-flex flex-col">
                                        <p className="text-[13px] lg:text-[12px] font-black text-primary tracking-tighter lg:tracking-tight">
                                          NPR {req.price.toLocaleString()}
                                        </p>
                                        <p className="text-[8px] lg:text-[7px] text-gray-400 font-black uppercase tracking-widest leading-none mt-0.5">
                                          {req.duration}
                                        </p>
                                      </div>
                                    </div>
                                    <div className="lg:w-[18%] lg:text-center">
                                      ...
                                      req.approvedAt ? (
                                        <div className="inline-flex flex-col items-center lg:items-center">
                                          ...
                                          <p className="text-[8px] lg:text-[7px] text-gray-400 font-bold lowercase tracking-tight opacity-70 mt-0.5">
                                            {req.startDate} → {req.endDate}
                                          </p>
                                        </div>
                                      ) : (
                                        <p className="text-[10px] lg:text-[9px] font-bold text-gray-400 lowercase tracking-tight opacity-70 truncate">
                                          {req.startDate} → {req.endDate}
                                        </p>
                                      )}
                                    </div>
                                  ...
                                  <div className="hidden lg:flex lg:w-[15%] items-center justify-center">
                                    <div
                                      className={`inline-flex px-2 py-0.5 rounded-md border text-[8px] font-black uppercase tracking-widest ${req.color}`}
                                    >
                                      {req.typeKey}
                                    </div>
                                  </div>
                                  ...
                                  <div className="lg:w-[12%] pt-4 lg:pt-0 border-t lg:border-none border-gray-50 flex items-center justify-between lg:justify-end gap-1.5">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                      <button
                                        onClick={() =>
                                          handleReviewAd(req.id, "approved")
                                        }
                                      ...
                                      <button
                                        onClick={() =>
                                          handleReviewAd(req.id, "rejected")
                                        }
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                      ...
                      <div className="overflow-hidden">
                        ...
                        <div className="hidden lg:flex bg-gray-50 border-b border-gray-100 px-8 py-4">
                          <div className="w-[40%] text-[10px] font-black uppercase tracking-widest text-gray-400">
                            Sponsorship Tier
                          </div>
                          <div className="w-[20%] text-center text-[10px] font-black uppercase tracking-widest text-gray-400">
                            1 Week
                          </div>
                          <div className="w-[20%] text-center text-[10px] font-black uppercase tracking-widest text-gray-400">
                            2 Weeks
                          </div>
                          <div className="w-[20%] text-center text-[10px] font-black uppercase tracking-widest text-[#C5A059]">
                            1 Month
                          </div>
                        </div>
                        ...
                        <div className="divide-y divide-gray-50">
                          {[
                            {
                              key: "featured",
                              label: "Featured Destination (Homepage)",
                              icon: "home",
                            },
                            {
                              key: "festival",
                              label: "Festival Highlight",
                              icon: "celebration",
                            },
                            {
                              key: "search_top",
                              label: "Top Search Priority",
                              icon: "manage_search",
                            },
                            {
                              key: "discounts",
                              label: "Exclusive Deals Section",
                              icon: "local_offer",
                            },
                          ].map((tier) => (
                            <div
                              key={tier.key}
                              className="flex flex-col lg:flex-row lg:items-center px-6 lg:px-8 py-6 lg:py-5 hover:bg-gray-50/20 transition-colors group"
                            >
                              ...
                              <div className="lg:w-[40%] flex items-center gap-3 mb-6 lg:mb-0">
                                <div className="w-10 h-10 lg:w-8 lg:h-8 rounded-xl lg:rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center group-hover:bg-primary group-hover:border-primary transition-all">
                                  <span className="material-icons text-gray-400 group-hover:text-white text-lg lg:text-[16px] transition-colors">
                                    {tier.icon}
                                  </span>
                                </div>
                                <span className="text-[14px] lg:text-[12px] font-black text-[#0D1F18]">
                                  {tier.label}
                                </span>
                              </div>
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-3 lg:contents gap-4">
                                {["1_week", "2_week", "1_month"].map((dur) => (
                                  <div
                                    key={dur}
                                    className="lg:w-[20%] lg:text-center"
                                  >
                                    <p className="text-[8px] text-gray-300 font-black uppercase tracking-widest lg:hidden mb-1.5">
                                      {dur.replace("_", " ")}
                                    </p>
                                    <div className="inline-flex items-center gap-1.5 bg-gray-50 border border-gray-100 rounded-xl lg:rounded-lg px-4 lg:px-3 py-2.5 lg:py-1.5 focus-within:border-primary focus-within:bg-white transition-all w-full lg:w-auto">
                                      <span className="text-gray-400 text-[10px] lg:text-[11px] font-bold">
                                        NPR
                                      </span>
                                      <input
                                        type="number"
                      ...
                      <div className="px-8 py-5 border-t border-gray-50 flex items-center justify-between bg-gray-50/30">
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                          Changes will reflect on the Advertisement portal
                          immediately
                        </p>
                  ...
                  {controlsTab === "creatives" && (
                    <div className="space-y-6">
                      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                        <div className="mb-6">
                          <h3 className="text-[13px] font-black text-[#0D1F18] uppercase tracking-[0.2em]">
                            Sponsored Banner Library
                          </h3>
                          <p className="text-[9px] font-bold text-gray-400 mt-1 uppercase tracking-widest">
                            Upload multiple banners per category. Recommended:
                            1200×300px — PNG, JPG, WEBP
                          </p>
                        </div>
                        <div className="space-y-6">
                          {[
                            ...
                            <div
                              key={cat.key}
                              className="border border-gray-100 rounded-xl overflow-hidden hover:border-primary/20 transition-all"
                            >
                              {/* Category Header */}
                              <div className="flex items-center justify-between px-5 py-3 border-b border-gray-50 bg-gray-50/40">
                                <div className="flex items-center gap-3">
                                  <div
                                    className={`w-7 h-7 rounded-lg border flex items-center justify-center ${cat.color}`}
                                  >
                                    <span className="material-icons text-[14px]">
                                      {cat.icon}
                                    </span>
                                  </div>
                                  <span className="text-[11px] font-black text-[#0D1F18] uppercase tracking-wide">
                                    {cat.label}
                                  </span>
                                </div>
                                <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">
                                  {adCreatives[cat.key].length} image
                                  {adCreatives[cat.key].length !== 1 ? "s" : ""}
                                </span>
                              </div>
                              ...
                              <div className="p-4">
                                <div className="flex flex-wrap gap-3">
                                  {adCreatives[cat.key].map((src, idx) => (
                                    <div
                                      key={idx}
                                      className="relative group/thumb rounded-lg overflow-hidden border border-gray-100 shadow-sm"
                                  ...
                                  {/* Add More Button */}
                                  <label
                                    className="cursor-pointer flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-200 hover:border-primary hover:bg-primary/5 transition-all gap-1"
                                  ...
                                  >
                                    ...
                                    />
                                    <span className="material-icons text-gray-300 text-[16px] group-hover:text-primary">
                                      add
                                    </span>
                        ...
                        <div className="mt-6 pt-5 border-t border-gray-50 flex items-center justify-between">
                          <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">
                            Banners cycle through rotation on the platform
                            automatically
                          </p>
                          <button className="px-8 h-10 rounded-xl bg-primary text-white text-[10px] font-black uppercase tracking-widest hover:bg-[#1D7447] transition-all shadow-md shadow-primary/20">
                  ...
                  {controlsTab === "toggles" && (
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                      <div className="p-8 border-b border-gray-50">
                        ...
                        <p className="text-[9px] font-bold text-gray-400 mt-1 uppercase tracking-widest">
                          Master system state management for the entire platform
                        </p>
                      </div>
                      <div className="p-8 space-y-6">
                        {toggles.map((control, i) => (
                          <div
                            key={control.id}
                            className="flex items-center justify-between group p-4 rounded-xl hover:bg-gray-50/50 transition-colors"
                          >
                            <div className="flex items-center gap-4">
                              ...
                              <div className="max-w-md">
                                <p className="text-[12px] font-black text-[#0D1F18] tracking-tight mb-0.5">
                                  {control.title}
                                </p>
                  ...
                  <div className="bg-[#0D1F18] rounded-2xl p-6 lg:p-8 flex flex-col lg:flex-row items-center lg:justify-between shadow-2xl shadow-[#1A2B23]/20 relative overflow-hidden text-center lg:text-left">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 relative z-10 mb-6 lg:mb-0">
                      ...
                      <div>
                        <p className="text-white text-[14px] font-black tracking-tight">
                          System Snapshot
                        </p>
                        <p className="text-white/40 text-[9px] font-black tracking-[0.2em] uppercase mt-1">
                          Last Sync: Operational • Auto-Save Enabled
                        </p>
                      </div>
                    </div>
                    <button className="w-full lg:w-auto px-8 h-12 rounded-xl bg-white text-[#0D1F18] text-[10px] font-black uppercase tracking-widest hover:brightness-90 transition-all relative z-10">
            ...
            >
              ...
              <div className="px-10 py-6 border-b border-gray-50 flex items-center justify-between bg-white">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-[15px] lg:text-lg font-black text-[#0D1F18] tracking-tight">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
                  ...
                  <div className="lg:col-span-3 space-y-10">
                    <div className="grid grid-cols-2 gap-x-12 gap-y-8">
                      {[
                        ...
                        {
                          label: "Location",
                          value: selectedAgent.location || "Nepal",
                          icon: "location_on",
                        },
                        {
                          label: "Phone Number",
                          value: selectedAgent.phoneNo || "NOT_SPECIFIED",
                          icon: "smartphone",
                        },
                        {
                          label: "PAN Number",
                          value: selectedAgent.panNumber,
                          icon: "corporate_fare",
                        },
                        {
                          label: "Citizenship ID",
                          value:
                            selectedAgent.citizenshipNumber || "C-12345-IDX",
                          icon: "badge",
                        },
                        {
                          label: "Issue District",
                          value:
                            selectedAgent.citizenshipDistrict || "KTM-NODE-01",
                          icon: "account_balance",
                        },
                        {
                          label: "Issue Date",
                          value:
                            selectedAgent.citizenshipIssueDate || "2023-01-12",
                          icon: "calendar_today",
                        },
                      ].map((d, i) => (
                        <div key={i} className="group">
                          <p className="text-[8px] lg:text-[9px] font-black text-gray-300 uppercase tracking-[0.2em] mb-2 lg:mb-2.5 group-hover:text-primary transition-colors">
                            {d.label}
                          </p>
                          <div className="flex items-center gap-2 lg:gap-3">
                            <div className="w-7 h-7 lg:w-8 lg:h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-primary/5 group-hover:text-primary transition-all">
                              <span className="material-icons text-[14px] lg:text-base">
                                {d.icon}
                              </span>
                            </div>
                            <p className="text-[11px] lg:text-[13px] font-bold text-[#0D1F18] tracking-tight">
                              {d.value}
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div className="p-5 lg:p-8 bg-gray-50/50 rounded-2xl lg:rounded-[32px] space-y-4 lg:space-y-6">
                      <h5 className="text-[9px] lg:text-[10px] font-black text-gray-400 uppercase tracking-[0.3em] pl-1 mb-2">
                        Uploaded Documents
                      </h5>
                      ...
                      <div
                        onClick={() =>
                          setPreviewImage(
                            selectedAgent.panImage?.startsWith("http")
                              ? selectedAgent.panImage
                              : `${import.meta.env.VITE_API_URL}${selectedAgent.panImage}`,
                          )
                        }
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <p className="text-[11px] font-black text-[#0D1F18] uppercase tracking-widest">
                            PAN Document
                          </p>
                        ...
                        <span className="material-icons text-gray-300 text-lg group-hover:text-primary transition-colors">
                          zoom_in
                        </span>
                      </div>
                      ...
                      >
                        <div className="w-12 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-300 group-hover:bg-primary/5 group-hover:text-primary transition-all overflow-hidden border border-gray-200">
                          {selectedAgent.citizenshipImage ? (
                            <img
                              src={
                                selectedAgent.citizenshipImage.startsWith(
                                  "http",
                                )
                                  ? selectedAgent.citizenshipImage
                                  : `${import.meta.env.VITE_API_URL}${selectedAgent.citizenshipImage}`
              ...
              <div className="px-6 lg:px-10 py-6 lg:py-8 border-t border-gray-50 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-0 bg-white">
                <div className="flex items-center gap-3 lg:gap-4 text-center lg:text-left">
                  ...
                  <p className="text-[8px] lg:text-[10px] font-black text-gray-400 uppercase tracking-widest leading-relaxed">
                    Review uploaded documents to verify agency
                  </p>
                </div>
                <div className="flex items-center gap-3 lg:gap-4 w-full lg:w-auto">
                  <button
                    onClick={() =>
                      handleVerifyAgent(selectedAgent.id, "rejected", false)
                    }
                  ...
                  <button
                    onClick={() =>
                      handleVerifyAgent(selectedAgent.id, "verified", true)
                    }
                  ...
                  >
                    <span className="material-icons text-[16px] lg:text-base">
                      verified_user
                    </span>
            ...
            >
              ...
              <div className="px-10 py-6 border-b border-gray-50 flex items-center justify-between bg-white">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-primary text-white rounded-xl lg:rounded-2xl flex items-center justify-center text-lg lg:text-xl font-black shadow-lg">
                    <span className="material-icons text-base lg:text-lg">
                      campaign
                    </span>
                  </div>
                  <div>
                    <h2 className="text-[15px] lg:text-lg font-black text-[#0D1F18] tracking-tight">
                      Ad Intelligence Console
                    </h2>
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-1.5 h-1.5 rounded-full ${selectedAdReview.status === "pending" ? "bg-amber-500 animate-pulse" : selectedAdReview.status === "approved" ? "bg-emerald-500" : "bg-red-500"}`}
                      />
                      <p className="text-[8px] lg:text-[9px] font-black text-gray-400 uppercase tracking-widest truncate max-w-[120px] lg:max-w-none">
                        {selectedAdReview.id} • {selectedAdReview.status} Node
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 overflow-y-auto p-5 lg:p-10 space-y-6 lg:space-y-8 no-scrollbar bg-white">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="space-y-6">
                    <div className="group">
                      <p className="text-[8px] lg:text-[9px] font-black text-gray-300 uppercase tracking-[0.2em] mb-2 lg:mb-2.5">
                        Sponsorship Entity
                      </p>
                      <p className="text-[14px] lg:text-[16px] font-black text-[#0D1F18] tracking-tight">
                        {selectedAdReview.agent}
                      </p>
                    </div>
                    <div className="group">
                      <p className="text-[8px] lg:text-[9px] font-black text-gray-300 uppercase tracking-[0.2em] mb-2 lg:mb-2.5">
                      ...
                      <p className="text-[11px] lg:text-[13px] font-bold text-gray-500 leading-tight">
                        {selectedAdReview.listing}
                      </p>
                    </div>
                    <div className="grid grid-cols-2 gap-4 lg:gap-6 pt-2 lg:pt-4">
                      <div>
                        <p className="text-[8px] lg:text-[9px] font-black text-gray-300 uppercase tracking-[0.2em] mb-1.5">
                          Sponsorship Tier
                        </p>
                        <span
                          className={`text-[8px] lg:text-[10px] font-black uppercase tracking-widest px-2 py-1 rounded-md border ${selectedAdReview.color}`}
                        >
                          {selectedAdReview.typeKey}
                        </span>
                      </div>
                      <div>
                        <p className="text-[8px] lg:text-[9px] font-black text-gray-300 uppercase tracking-[0.2em] mb-1.5">
                        ...
                        <p className="text-[12px] lg:text-[14px] font-black text-primary truncate">
                          NPR {selectedAdReview.price.toLocaleString()}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 lg:space-y-6 bg-gray-50 rounded-2xl lg:rounded-3xl p-5 lg:p-6 border border-gray-100">
                    <div className="group">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-[10px] lg:text-[12px] font-bold text-[#0D1F18] tracking-tight">
                          {selectedAdReview.startDate} →{" "}
                          {selectedAdReview.endDate}
                        </p>
                      </div>
                    </div>
                    <div className="group">
                      ...
                      <p className="text-[11px] lg:text-[12px] font-black text-[#0D1F18]">
                        {selectedAdReview.duration}
                      </p>
                    </div>
                    <div className="pt-4 border-t border-gray-200">
                      ...
                      <a
                        href={selectedAdReview.link}
                        target="_blank"
                        rel="noreferrer"
                        className="flex items-center gap-1.5 text-[9px] lg:text-[10px] font-black text-primary hover:underline group"
                      >
                        <span className="material-icons text-sm">link</span>
                        <span className="truncate max-w-[150px] lg:max-w-[180px]">
                          {selectedAdReview.link}
                        </span>
                      </a>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  {selectedAdReview.status === "rejected" &&
                    selectedAdReview.rejectionReason && (
                      <div className="bg-red-50 border border-red-100 rounded-3xl p-6">
                        <p className="text-[9px] font-black text-red-600 uppercase tracking-[0.2em] mb-2.5">
                          Protocol Rejection Reason
                        </p>
                        <p className="text-[12px] font-bold text-red-900 leading-relaxed italic">
                          "{selectedAdReview.rejectionReason}"
                        </p>
                      </div>
                    )}
                  <div className="space-y-4">
                    ...
                    <div className="w-full h-32 rounded-[24px] bg-gray-50 border border-gray-100 flex items-center justify-center group overflow-hidden relative">
                      <span className="material-icons text-gray-200 text-4xl group-hover:scale-110 transition-transform">
                        image
                      </span>
                      <div className="absolute inset-x-0 bottom-0 p-3 bg-white/80 backdrop-blur-sm flex justify-center border-t border-gray-100">
                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-[0.2em]">
                          Banner Simulation Logic Loaded
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="px-6 lg:px-10 py-6 lg:py-8 border-t border-gray-50 flex flex-col lg:flex-row items-center justify-end gap-3 lg:gap-4 bg-gray-50/10">
                <button
                  onClick={() =>
                    handleReviewAd(selectedAdReview.id, "rejected")
                  }
                ...
                <button
                  onClick={() =>
                    handleReviewAd(selectedAdReview.id, "approved")
                  }
                ...
                >
                  <span className="material-icons text-base">
                    {selectedAdReview.status === "approved"
                      ? "verified"
                      : "publish"}
                  </span>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-1">
                  <h3 className="text-xl font-black text-[#0D1F18] tracking-tight uppercase">
                    Audit Rejection Protocol
                  </h3>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-relaxed">
                    Enter manual justification for legal non-compliance
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <textarea
                  ...
                  placeholder={
                    rejectionError
                      ? "JUSTIFICATION REQUIRED: Provide precise details for rejection node..."
                      : "Describe compliance violation detail..."
                  }
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-relaxed">
                    Proceed with authorizing this sponsorship node?
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 italic">
                <p className="text-[11px] font-bold text-gray-500 text-center leading-relaxed">
                  "I confirm that all creative assets and target destinations
                  for this ad campaign have been audited and meet platform
