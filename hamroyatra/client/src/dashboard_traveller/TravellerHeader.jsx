...
const TravellerHeader = ({ user, onLogout, onTabChange, onToggleSidebar }) => {
        ...
        <header className="h-[72px] bg-white border-b border-gray-100 flex items-center justify-between px-4 md:px-8 shrink-0 z-30 relative w-full">
            <div className="flex items-center gap-4">
                ...
                <div className="hidden sm:block">
                    <h1 className="text-[13px] md:text-[15px] font-black text-[#0D1F18] tracking-tight">
                        Good {getGreeting()}, {user?.fullName?.split(' ')[0] || 'Traveller'}
                    </h1>
            ...
            <div className="flex items-center gap-5">
                ...
                <div className="relative" ref={notificationRef}>
                    ...
                    >
                        ...
                        {hasUnread && <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-[#C5A059] rounded-full border-2 border-white animate-pulse" />}
                    </button>
                    ...
                    <AnimatePresence>
                        {showNotifications && (
                            <motion.div
                                ...
                                className="absolute right-0 mt-4 w-80 bg-white rounded-[24px] shadow-[0_25px_60px_rgba(0,0,0,0.15)] border border-gray-50 overflow-hidden z-20"
                            >
                                ...
                                <div className="max-h-[400px] overflow-y-auto">
                                    {loadingNotifs ? (
                                        ...
                                        notifications.filter(n => {
                                            ...
                                            <div 
                                                ...
                                                onClick={() => {
                                                    ...
                                                    if (notif.type === 'booking' || notif.type === 'status') {
                                            ...
                                            >
                                                <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 transition-transform group-hover:scale-110 ${
                                                    notif.type === 'booking' || notif.type === 'status' ? 'bg-emerald-50 text-emerald-600' : 'bg-amber-50 text-amber-600'
                                                }`}>
                                                    <span className="material-icons text-[18px]">
                                                        {notif.type === 'booking' || notif.type === 'status' ? 'verified' : 'info'}
                                                    </span>
                                                </div>
                                        ...
                                        <div className="py-12 text-center text-gray-100">
                                            <span className="material-icons text-[40px] mb-2">notifications_off</span>
                ...
                <div className="relative" ref={dropdownRef}>
                    ...
                    >
                        ...
                        <div className="hidden lg:block text-left">
                            <p className="text-[13px] font-black text-[#0D1F18] leading-none group-hover:text-[#C5A059] transition-colors">{user?.fullName || 'Traveller'}</p>
                            <p className="text-[9px] text-[#C5A059] mt-1.5 uppercase font-bold tracking-widest opacity-80">Traveller Portal</p>
                        </div>
                    ...
                    <AnimatePresence>
                        {showDropdown && (
                            <motion.div
                                ...
                                className="absolute right-0 mt-4 w-56 bg-white rounded-[24px] shadow-[0_30px_70px_rgba(0,0,0,0.15)] border border-gray-50 py-3 overflow-hidden z-20"
                            >
                                ...
                                <button className="w-full flex items-center gap-3 px-5 py-4 text-[11px] font-bold text-gray-600 hover:bg-gray-50 hover:text-[#0D1F18] transition-all group/opt">
