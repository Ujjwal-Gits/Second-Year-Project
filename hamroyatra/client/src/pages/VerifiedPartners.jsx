...
const PartnerCard = ({ partner, index }) => {
  const profileImg = partner.profileImage
    ? partner.profileImage.startsWith("http")
      ...
      : `http://localhost:5000${partner.profileImage}`
    : null;
          ...
          <img
            src={
              partner.coverImage.startsWith("http")
                ? partner.coverImage
                : `http://localhost:5000${partner.coverImage}`
            }
            alt=""
...
const VerifiedPartners = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/public/agents/verified")
  ...
  return (
    <div className="min-h-screen bg-[#F7F6F3] font-display">
            ...
            <div className="flex items-center gap-1.5 md:gap-2 overflow-x-auto no-scrollbar">
              {CATEGORIES.map((cat) => (
                <button
                  ...
                  className={`flex items-center gap-1.5 md:gap-2 px-3.5 md:px-5 py-2 md:py-2.5 rounded-full transition-all duration-300 text-[9px] md:text-[10px] font-black uppercase tracking-widest whitespace-nowrap ${activeFilter === cat.id ? "bg-primary text-white shadow-md shadow-primary/20" : "bg-gray-50 text-gray-400 hover:bg-gray-100 hover:text-gray-600"}`}
                >
                  <span
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-[1280px] mx-auto px-4 md:px-10 py-4 flex items-center gap-6 overflow-x-auto">
          {[
            {
              icon: "verified",
            ...
            },
            {
              ...
              value:
                partners
                  .reduce((a, p) => a + (p.followers?.length || 0), 0)
                  .toLocaleString() || "—",
            },
            {
              icon: "explore",
          ...
          <span className="ml-auto text-[10px] font-bold text-gray-400 uppercase tracking-widest shrink-0">
